	         ...
	         <tr >
	            ...
	            <?php if (!empty($resultSet)) {  foreach($resultSet as $res) {?>
	        		<tr>
		               ...
		               <a href="<?php echo $helper->url("ConsultaDocumentosImpulsores","abrirPdf"); ?>&id=<?php echo $res->id_documentos; ?>" onclick="window.open(this.href, this.target, ' width=1000, height=800, menubar=no');return false" class="btn btn-success" onClick="Ok()" style="font-size:70%;"> VER </a>
		               </td> 
