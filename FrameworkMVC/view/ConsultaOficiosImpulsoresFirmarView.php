...
<html lang="es">
      ...
      <head>
        ...
        <meta charset="utf-8"/>
        <title>Consulta Oficios Impulsores Firmar - coactiva 2016</title>
 ...
 $sel_id_ciudad = "";
  ...
  <div class="row" style="background-color: #ffffff;">
      ...
      <form action="<?php echo $helper->url("ConsultaOficiosImpulsores","consulta_oficios_impulsor"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-12">
		 ...
		 <input type="submit" value="Firmar" id="firmar" name="firmar" onclick="this.form.action='index.php?controller=ConsultaOficiosImpulsores&action=EnviarApplet'" class="btn btn-info" style="margin-top: 10px;"/>
