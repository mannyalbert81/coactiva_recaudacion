	            ...
	            <?php if (!empty($resultSet)) {  foreach($resultSet as $res) {?>
	        		<tr>
		               ...
		               <td style="color:#000000;font-size:80%;"> <?php echo $res->nombre_estado_procesal_juicios; ?>     </td> 
		           	   ...
		           	   <td>
			           		<div class="right">
			                    <a href="<?php echo $helper->url("EstadosProcesales","index"); ?>&id_estados_procesales_juicios=<?php echo $res->id_estados_procesales_juicios; ?>" class="btn btn-warning" onClick="notificacion()" style="font-size:65%;">Editar</a>
			                </div>
			            
			             </td>
			             <td>   
			                	<div class="right">
			                    <a href="<?php echo $helper->url("EstadosProcesales","borrarId"); ?>&id_estados_procesales_juicios=<?php echo $res->id_estados_procesales_juicios; ?>" class="btn btn-danger" onClick="Borrar()" style="font-size:65%;">Borrar</a>
			                </div>
			                <hr/>
		               </td>
		    		</tr>
