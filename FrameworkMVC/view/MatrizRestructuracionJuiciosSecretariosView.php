...
<html lang="es">
	...
	function load_matriz(pagina){
		...
		$("#matriz").fadeIn('slow');
		$.ajax({
			url:"<?php echo $helper->url("MatrizJuicios","index7");?>",
            type : "POST",
            async: true,			
			data: con_datos,
      ...
      <form action="<?php echo $helper->url("MatrizJuicios","index7"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-12" target="_blank">
        ...
        <div class="col-lg-2 col-md-2 xs-6">
		 ...
		 <button type="button" id="buscar" name="buscar" value="Buscar"   class="btn btn-info" style="margin-top: 10px;"><i class="glyphicon glyphicon-search"></i></button>
		  <button type="submit" id="reporte_rpt_restructuración" name="reporte_rpt_restructuración"    class="btn btn-success" style="margin-top: 10px;"><i class="glyphicon glyphicon-print"></i> Restructuración Juicios</button>         
