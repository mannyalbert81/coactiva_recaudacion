...
<html lang="es">
      ...
      <head>
        ...
        <meta charset="utf-8"/>
        <title>Consulta Oficios Impulsores Firmados- coactiva 2016</title>
  ...
  <div class="row" style="background-color: #ffffff;">
      ...
      <form action="<?php echo $helper->url("ConsultaOficiosImpulsores","consulta_oficios_impulsores_firmados"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-12">
         
         <!-- comienxza busqueda  -->
         <div class="col-lg-12" style="margin-top: 10px">
         
       	 <h4 style="color:#ec971f;">Consulta Oficios Impulsores Firmados</h4>
