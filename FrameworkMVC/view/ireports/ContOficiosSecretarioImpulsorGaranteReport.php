...
$estado=$_GET['estado'];
		...
		if ($estado == 'Visualizar') 
		{
			...
			$PHPJasperXML->load_xml_file( "OficiosSecretarioImpulsorGaranteVisualizarReport.jrxml" );
		...
		} elseif($estado=='Guardar')
		{
			...
			$hora = date ("h:i:s");
			 ...
			 $PHPJasperXML->load_xml_file("OficiosSecretarioImpulsorGaranteGuardarReport.jrxml");
