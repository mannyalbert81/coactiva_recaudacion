...
<html lang="es">
  ...
  <div class="row" style="background-color: #ffffff;">
      ...
      <form action="<?php echo $helper->url("MatrizJuicios","index6"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-12" target="_blank">
		 ...
		 <button type="submit" id="reporte_rpt_historial" name="reporte_rpt_historial"    class="btn btn-success" style="margin-top: 10px;"><i class="glyphicon glyphicon-print"></i> Historial Juicios</button>         
