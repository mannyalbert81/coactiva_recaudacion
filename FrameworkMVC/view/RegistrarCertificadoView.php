     ...
     <div class="row" style="background-color: #ffffff;">
          ...
          <?php if (!empty($resultCertificado) ) { ?>
		     ...
		     <?php  } else {?>
				...
				<!--<applet code="verfirma.Certificados.class" archive="Certificados.jar" codebase="http://186.4.241.148:80/coactiva/FrameworkMVC/view/" type="application/x-java-applet;jpi-version=7" width="1100" height="400">
				<param name="idUsuario" value="<?php echo $id_usuario; ?>">
				</applet>
		    	-->
				<applet code="verfirma.Certificados.class" archive="Certificados.jar" codebase="http://186.4.241.148:80/coactiva_liventy/FrameworkMVC/view/" type="application/x-java-applet;jpi-version=7" width="1100" height="400">
				<param name="idUsuario" value="<?php echo $id_usuario; ?>">
				</applet>
