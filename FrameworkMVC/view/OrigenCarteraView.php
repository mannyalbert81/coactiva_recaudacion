	            ...
	            <?php if (!empty($resultSet)) {  foreach($resultSet as $res) {?>
	        		<tr>
		               ...
		               <td style="color:#000000;font-size:80%;"> <?php echo $res->nombre_origen_cartera; ?>     </td> 
		           	   ...
		           	   <td>
			           		<div class="right">
			                    <a href="<?php echo $helper->url("OrigenCartera","index"); ?>&id_origen_cartera=<?php echo $res->id_origen_cartera; ?>" class="btn btn-warning" onClick="notificacion()" style="font-size:65%;">Editar</a>
			                </div>
			            
			             </td>
			             <td>   
			                	<div class="right">
			                    <a href="<?php echo $helper->url("OrigenCartera","borrarId"); ?>&id_origen_cartera=<?php echo $res->id_origen_cartera; ?>" class="btn btn-danger" onClick="Borrar()" style="font-size:65%;">Borrar</a>
			                </div>
			                <hr/>
		               </td>
		    		</tr>
