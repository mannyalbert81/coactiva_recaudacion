	            ...
	            <?php if (!empty($resultSet)) {  foreach($resultSet as $res) {?>
	        		<tr>
		               ...
		               <td style="color:#000000;font-size:80%;"> <?php echo $res->nombre_tipo_persona; ?>     </td> 
		           	   ...
		           	   <td>
			           		<div class="right">
			                    <a href="<?php echo $helper->url("TipoPersona","index"); ?>&id_tipo_persona=<?php echo $res->id_tipo_persona; ?>" class="btn btn-warning" onClick="notificacion()" style="font-size:65%;">Editar</a>
			                </div>
			            
			             </td>
			             <td>   
			                	<div class="right">
			                	<a href="<?php echo $helper->url("TipoPersona","borrarId"); ?>&id_tipo_persona=<?php echo $res->id_tipo_persona; ?>" class="btn btn-danger" onClick="Borrar()" style="font-size:65%;">Borrar</a>
			                </div>
			                <hr/>
		               </td>
		    		</tr>
