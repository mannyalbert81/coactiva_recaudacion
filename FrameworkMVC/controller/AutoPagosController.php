				...
				$usuarios->MostrarNotificaciones($_SESSION['id_usuarios']);
					...
					if(isset($_POST["buscar"])){
						...
						$where    = "clientes.id_clientes = titulo_credito.id_clientes AND
	                         ciudad.id_ciudad = titulo_credito.id_ciudad AND titulo_credito.id_usuarios = usuarios.id_usuarios AND titulo_credito.asignado_titulo_credito='TRUE' AND titulo_credito.id_usuarios='$_id_usuarios'";
